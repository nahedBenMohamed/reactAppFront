...
const BodyTable2NSection = ({ t, val}) => {
	return (
		<View wrap={false} style={styles.tableRow}>
			<View style={val[1].word ? styles.colAccordionWord1 : styles.colAccordionPronunciation1}>
			...
			<View style={val[1].word ? styles.colAccordionWord2 : styles.colAccordionPronunciation2}>
				<Text style={styles.tableCellContent}>
					{val[1].score ? val[1].score : val[1].word ? val[1].word : val[1]}
				</Text>
			</View>
		</View>
	);
